 ...
 */
#define CONNECTION_CID      g_hr_data.st_ucid
#define IS_BONDED           g_hr_data.bonded
#define CONN_CENTRAL_ADDR   g_hr_data.con_bd_addr
#define CONNECTION_IRK      g_hr_data.central_device_irk.irk
#define LINK_DIVERSIFIER    g_hr_data.diversifier
