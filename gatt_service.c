...
extern void GattOnConnection(uint16 st_ucid,bool bonding_exists)
{
    if(bonding_exists)
    {        
       ...
       /* Read service changed client configuration descriptor from NVM if 
        ...
        */
           ...
           (g_gatt_data.serv_changed_config == gatt_client_config_indication))
        {
            ...
            /* Now that the indication has been sent, clear the flag in the
             * NVM 
             */
            g_gatt_data.serv_changed = FALSE;
